...
namespace blogProject.Controllers
{
    ...
    public class BlogController : Controller
    {
        ...
        public ActionResult BlogByCategory(int id)
        {
            ...
            {
                ViewBag.categoryName = blogs.Select(y => y.Category?.Name).FirstOrDefault();
                ViewBag.categoryDescription = blogs.Select(y => y.Category?.Description).FirstOrDefault();
            }
            else
            {
                // blogs null veya boşsa, uygun bir işlemi gerçekleştirin
                ViewBag.categoryName = "Kategori Adı Bulunamadı";
                ViewBag.categoryDescription = "Kategori Açıklaması Bulunamadı";
            }
